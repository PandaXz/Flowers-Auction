...
<head>
    ...
    <title><fmt:message key="user-lots.title" bundle="${rb}"/> </title>
            ...
            <c:if test="${not empty lotList}">
                <div class="table-responsive">
                    <table class="table table-hover table-style">
                        <thead>
                        <tr>
                            <th><fmt:message key="user-lots.owner" bundle="${rb}"/></th>
                            <th><fmt:message key="user-lots.flowerName" bundle="${rb}"/></th>
                            <th><fmt:message key="user-lots.end" bundle="${rb}"/></th>
                            <th><fmt:message key="user-lots.count" bundle="${rb}"/></th>
                            <th><fmt:message key="user-lots.price" bundle="${rb}"/></th>
                            <th><fmt:message key="user-lots.state" bundle="${rb}"/></th>
                        </tr>
                        </thead>
                        <tbody>
