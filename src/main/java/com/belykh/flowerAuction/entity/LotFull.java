...
public class LotFull {
     ...
     */
    public LotFull(Long id, UserInfo buyer, UserInfo owner, FlowerDTO flower, Address address, BigDecimal startPrice, BigDecimal currentPrice, LotState state, int count, LocalDateTime end, String description, String filePath) {
        this.id = id;
        this.buyer = buyer;
        this.owner = owner;
        this.flower = flower;
