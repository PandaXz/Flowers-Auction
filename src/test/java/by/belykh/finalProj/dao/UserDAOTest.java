...
import com.belykh.flowerAuction.dao.impl.UserDAOImpl;
...
public class UserDAOTest extends Assert {
    ...
    public void addUser_Test() throws  DAOException {
        UserDTO user = new UserDTO(7l, "SuperPuperUser", "827CCB0EEA8A706C4C34A16891F84E7B", "super.user@gmail.com", "Super", "User", 1, new BigDecimal("0.0000"));
    ...
    public void changePassword_Test() throws  DAOException {
        UserDTO user = new UserDTO(5l, "SuperUser", "AAAA", "super.user@gmail.com", "Super", "User", 1, new BigDecimal("99900.0000"));
    ...
    public void changeUserInfo_Test() throws  DAOException {
        UserDTO user = new UserDTO(5l, "SuperUser", "827CCB0EEA8A706C4C34A16891F84E7B", "superPuper.user@gmail.com", "SuperPuper", "User", 1, new BigDecimal("99900.0000"));
    ...
    public void changeMoney_Test() throws  DAOException {
        UserDTO user = new UserDTO(5l, "SuperUser", "827CCB0EEA8A706C4C34A16891F84E7B", "super.user@gmail.com", "Super", "User", 1, new BigDecimal("100.0000"));
