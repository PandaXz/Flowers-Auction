...
import com.belykh.flowerAuction.dao.impl.AddressDAOImpl;
...
public class AddressDAOTest extends Assert {
    ...
    public void findAddressById_Test() throws DAOException {
        AddressDTO address = new AddressDTO(1l, "Lenina", 1, 1l);
    ...
    public void addAddress_Test() throws DAOException {
        AddressDTO address = new AddressDTO(7l, "Lenina", 1, 2l);
